...
namespace DataAction
{
    ...
    public static class SaveStatic
    {
        ...
        public static void SaveTxtC(string _path, IEnumerable<string[]> _contents, bool _append)
        {
            lock (lock_txt)
            {
                string str = "";
        ...
        public static void SaveBinF(string _name, object _obj)
        {
            ...
            Stream stream = new FileStream("F:\\BinData\\" + _name + ".bin", FileMode.OpenOrCreate, FileAccess.Write, FileShare.None);
        ...
        public static object ReadBinF(string _name)
        {
            ...
            {
                IFormatter formatter = new BinaryFormatter();
                Stream streamc = new FileStream("F:\\BinData\\" + _name + ".bin", FileMode.Open, FileAccess.Read, FileShare.None);
