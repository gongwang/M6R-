...
namespace FastCtr
{
    public partial class UserChart : UserControl
    {
        ...
        public void InitChartset()
        {
            ...
            {
                SaveStatic.SaveTxt(Application.StartupPath + "\\chartset.txt", "", false);
                FileSystemWatcher fsw = new FileSystemWatcher(Path.GetDirectoryName(Application.StartupPath + "\\chartset.txt"), "*.txt");
                fsw.EnableRaisingEvents = true;
                fsw.NotifyFilter = NotifyFilters.LastWrite;
                fsw.Changed += new FileSystemEventHandler(fsw_Changed);
        ...
        public void fresh()
        {
            if(Flag)
            {
                ...
                if (File.Exists(Application.StartupPath + "\\chartset.txt"))
                {
                    string[][] aa = SaveStatic.ReadMultiTxt(Application.StartupPath + "\\chartset.txt");
            ...
            {
                if (SaveStatic.ReadMultiTxt(listdatabinPath[0]) == null)
                {
                    return;
                }
                string[][] _d0 = SaveStatic.ReadMultiTxt(listdatabinPath[0]);
            ...
            {
                if (SaveStatic.ReadMultiTxt(listdatabinPath[1]) == null)
                {
                    return;
                }
                string[][] _d1 = SaveStatic.ReadMultiTxt(listdatabinPath[1]);
            ...
            {
                if (SaveStatic.ReadMultiTxt(listdatabinPath[2]) == null)
                {
                    return;
                }
               
                string[][] _d2 = SaveStatic.ReadMultiTxt(listdatabinPath[2]);
            ...
            if (listdatabinPath[3] != "")
            {
                ...
                if (SaveStatic.ReadMultiTxt(listdatabinPath[3]) == null)
                {
                    return;
                }
                string[][] _d3 = SaveStatic.ReadMultiTxt(listdatabinPath[3]);
            ...
            {
                if (SaveStatic.ReadMultiTxt(listdatabinPath[4]) == null)
                {
                    return;
                }
                string[][] _d4 = SaveStatic.ReadMultiTxt(listdatabinPath[4]);
            ...
            if (listdatabinPath[5] != "")
            {
                ...
                if (SaveStatic.ReadMultiTxt(listdatabinPath[5]) == null)
                {
                    return;
                }
                string[][] _d5 = SaveStatic.ReadMultiTxt(listdatabinPath[5]);
            ...
            {
                if (SaveStatic.ReadMultiTxt(listdatabinPath[6]) == null)
                {
                    return;
                }
                string[][] _d6 = SaveStatic.ReadMultiTxt(listdatabinPath[6]);
            ...
            {
                if (SaveStatic.ReadMultiTxt(listdatabinPath[7]) == null)
                {
                    return;
                }
                string[][] _d7 = SaveStatic.ReadMultiTxt(listdatabinPath[7]);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            setchart.FormBorderStyle = FormBorderStyle.FixedToolWindow;
            setchart.StartPosition = FormStartPosition.CenterScreen;
            setchart.ShowDialog();
        }
        ...
        private void setchart_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            SaveStatic.SaveTxt(Application.StartupPath + "\\chartset.txt", info, false);
        }
